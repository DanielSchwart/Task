					 ...
					 <?php
							...
							<div class='row'>
								<div class='col-md-12'>
									<div class='account-create-box'>
										<h2 class='box-info'>Форма заполнения задачи</h2>
										<div class='row'>
						...
						<div class="col-md-12">
							<div class="area-title">
								<h3 class="title-group gfont-1">Список задач</h3>
...
if( $page > 1 ) echo'<li><a href="index.php?page='.($page-1).'"><</a>';
if( $page < $pages ) echo '<li><a href="index.php?page='.($page+1).'">> </a>';
echo"</div>
</div>
														</div>
														<div class='col-xs-7'>
