...
<div class="login-page">
  <div class="form"  >
<form class="login-form" action="su.php" onload="resizeIframe(this)" enctype="multipart/form-data" method="post"> 
 <table class="table-login">
          <TR> <TD align="center" height="40pxs">Выберете задачу которую хотите считать выполненой</TD></TR>
       </table>
